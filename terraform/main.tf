...
# Projeto: aws-secure-webapp-ec2-vpc
# Autor: Luciano Girao
# ==============================================================
...
resource "aws_iam_role" "ec2_role" {
  ...
  tags = { Name = "${var.project_name}-ec2-role", Project = var.project_name }
}
...
resource "aws_instance" "web" {
  ...
  user_data = base64encode(<<-EOF
    ...
    echo '<h1>AWS Secure WebApp - EC2 inside VPC</h1>' > /var/www/html/index.html
  EOF
  )

  tags = { Name = "${var.project_name}-web-server", Project = var.project_name }
}
